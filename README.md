...
- [**rag-approval-blueprint**](https://github.com/leonkoellerwirth-arch/rag-approval-blueprint) — the other half: not how to build a compliant RAG assistant, but how to get it approved — approval file, control catalogue with test procedures, deletion evidence, and a worked approval run (DORA/MaRisk)
